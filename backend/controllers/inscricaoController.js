...
const candidatarVaga = async (req, res) => {
  try {
    ...
    if (req.user.type_user_id !== 2) {  // Ajuste o valor de '2' conforme o seu modelo (por exemplo, 2 para profissional)
      return res.status(403).json({ message: 'Empresas não podem se candidatar a vagas.' });
    }
