const { User, TypeUser, UserProfissionalProfile, UserEmpresaProfile } = require('../models/Users');
...
const loginUser = async (req, res) => {
  ...
  try {
    ...
    const token = jwt.sign({ id: user.id, type_user_id: user.type_user_id }, process.env.JWT_SECRET, { expiresIn: '1h' });
