...
router.post(
  "/candidatar/:vagaId",
  authMiddleware,
  InscricaoController.candidatarVaga
);
...
router.get(
  "/acompanhamento",
  authMiddleware,
  InscricaoController.acompanharCandidatura
);
...
router.get(
  "/candidatos/:vagaId",
  authMiddleware,
  InscricaoController.obterCandidatos
);
...
router.put(
  "/status/:inscricaoId",
  authMiddleware,
  InscricaoController.alterarStatus
);

// Rota para obter o perfil de um candidato
router.get("/perfil/:userId", InscricaoController.obterPerfilCandidato);

// Rota para obter perfil de um candidato e dados da inscrição
router.get(
  "/detalhes/:inscricaoId",
  authMiddleware,
  InscricaoController.obterInscricaoComPerfil
);
